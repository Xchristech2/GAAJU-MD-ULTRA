...
module.exports = {
  ...
  async execute(_0x525ebb, _0x3616aa, _0x5d3c4d, _0x5cc8aa, _0x22b405) {
    ...
    try {
      ...
      const _0x453d7b = _0x276ebc.participants.filter(
        _0xea7d8b =>
          _0xea7d8b.admin === "admin" ||
          _0xea7d8b.admin === "superadmin"
      );
      ...
      const _0x465050 = await Promise.all(
        _0x453d7b.map(async _0x4ebe9c => {

          const _0x1464c7 =
            _0x4ebe9c.admin === "superadmin"
              ? "👑"
              : "⭐";

          const _0x51f185 = await resolveDisplayWithName(
            _0x525ebb,
            _0x6a4818,
            _0x4ebe9c.id || "",
            _0x4ebe9c.notify || null
          );
