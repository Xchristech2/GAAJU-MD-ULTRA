  ...
  async execute(_0x2b0d71, _0x51a6fa, _0x3163ce, _0x1fd591, _0x56909b) {
    ...
    try {
      await _0x2b0d71.sendMessage(_0x1adf15, {
        react: { text: "⚠️", key: _0x51a6fa.key }
      });
    } catch {}
    ...
    const _0x5eee8c =
      _0x3163ce.filter(x => !x.startsWith("@")).join(" ").trim() ||
      "No reason given";

    const _0x211d17 =
      await resolveDisplay(_0x2b0d71, _0x1adf15, _0x47987d);
    ...
    if (_0x5b8264 >= MAX_WARNS) {
      try {
        await _0x2b0d71.groupParticipantsUpdate(
          _0x1adf15,
          [_0x47987d],
          "remove"
        );
...
},
{
  ...
  async execute(_0x151c51, _0x8c3f61, _0x1858a5, _0x28816d, _0x3a4142) {
    ...
    const _0x214ede =
      await resolveDisplay(_0x151c51, _0x4b37a7, _0x48732a);

    const _0x2aa9d6 = loadWarns();
    const _0x3b9c7e =
      _0x2aa9d6[getKey(_0x4b37a7, _0x48732a)] || 0;
...
},
{
  ...
  async execute(_0x54ec08, _0x4f31af, _0x196d11, _0x2f7d4b, _0x35f92b) {
    ...
    const _0x252b95 =
      await resolveDisplay(_0x54ec08, _0x4b76c5, _0x282419);
