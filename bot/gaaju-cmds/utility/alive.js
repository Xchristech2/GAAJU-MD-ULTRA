  ...
  async execute(_0x891d1b, _0x134a78, _0x57dee3, _0xd4c078, _0x2dbf50) {
    ...
    const _0x4b2823 = (..._0x2ea9bf) => {
      ...
      try {
        ...
        const _0x535f85 = JSON.parse(
          require("fs").readFileSync(_0x7d7064, "utf8")
        );
        ...
        if (_0x3784b && !_0x3784b.includes("@lid")) {
          ...
          _0x17162e = _0x16111f(
            _0x3784b.split("@")[0].split(":")[0]
          );
        }

      } catch (_0x41e7ab) {}

      for (const _0x40b718 of [
        process.env.OWNER_NUMBER,
        require("../../config").OWNER_NUMBER,
        _0x17162e,
        ..._0x2ea9bf
      ]) {
    ...
    const _0xee2787 = _0x4b2823(
      global.OWNER_NUMBER,
      global.OWNER_CLEAN_NUMBER
    );

    const _0x121962 = _0xee2787
      ? "+" + _0xee2787
      : "Unknown";
    ...
    const _0x3adf28 = [
      ...
      "║ ▸ *Platform* : Replit",
      "║ ▸ *Mode*     : " + _0x4bc523,
      "║ ▸ *Uptime*   : " + _0x5dfa83 + "h " + _0x32d129 + "m " + _0x5b3b10 + "s",
      "║ ▸ *Status*   : CONNECTED ✅",
      "║",
      "║ ▸ *Channel*  :",
