...
const _0x5d554a =
_0x4d88ff.key.participant ||
_0x4d88ff.key.remoteJid;

const _0x1e8d90 =
_0x1352e9.endsWith("@g.us");
...
const _0x3aefd2 =
_0x392d88 + "@s.whatsapp.net";

const _0x433f96 =
_0x4d88ff.message?.extendedTextMessage?.contextInfo;
...
const _0x142695 =
_0x5630ee.viewOnceMessageV2?.message ||
_0x5630ee.viewOnceMessageV2Extension?.message;
...
const _0x49f9e0 =
_0x5630ee.viewOnceMessage?.message;
...
const _0xbf71a2 =
_0x5630ee.ephemeralMessage?.message;

if (_0xbf71a2) {

const _0x1b84f5 =
_0xbf71a2.viewOnceMessageV2?.message ||
_0xbf71a2.viewOnceMessageV2Extension?.message;
...
const _0x44063e =
_0xbf71a2.viewOnceMessage?.message;
...
const _0x3cbfeb =
globalThis.viewOnceCache_ref;

const _0x47d539 =
_0x3cbfeb?.get(
_0x1352e9 + "|" + _0x23e8e8
) ||
_0x3cbfeb?.get(_0x23e8e8);

const _0x4ced21 =
_0x47d539?.message ||
_0x47d539 ||
_0x433f96.quotedMessage;
...
throw new Error(
"Empty buffer — media key may be stripped from view-once quote"
);
}
...
/*
Always send the revealed media
to the same chat where .vv was used.
*/
const _0x474f87 = _0x1352e9;

if (_0x57f4c3 === "image") {

await _0x395ce8.sendMessage(
_0x474f87,
{
image: _0x316e4c,
caption: _0x537d8f
